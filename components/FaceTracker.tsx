...
export const FaceTracker = forwardRef<FaceTrackerHandle, FaceTrackerProps>(({ onMotion, isActive }, ref) => {
  ...
  useEffect(() => {
    ...
    if (isActive) {
      ...
      pitchHistoryRef.current = [];// Recalibrate center point when game starts
  ...
  useEffect(() => {
    ...
    try {
      ...
      faceMesh.onResults((results: any) => {
        ...
        const pitch = (avgNoseY - (centerNoseYRef.current ?? 0)) * 200;
